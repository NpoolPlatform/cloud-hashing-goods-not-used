...
func run(wg *sync.WaitGroup) {
	...
	if err := npool.RegisterCloudHashingGoodsHandlerFromEndpoint(context.Background(), mux, "127.0.0.1:9099", []grpc.DialOption{grpc.WithInsecure()}); err != nil {
		log.Panic(err)
	}
...
func TestCreateVendorLocation(t *testing.T) {
