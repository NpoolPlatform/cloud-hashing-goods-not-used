...
type FeeDetail struct {
	...
	Fee   *FeeType `protobuf:"bytes,2,opt,name=Fee,proto3" json:"Fee,omitempty"`
...
var file_npool_cloud_hashing_goods_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x52, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x64, 0x0a,
	0x09, 0x46, 0x65, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x49, 0x44, 0x12, 0x31, 0x0a, 0x03, 0x46, 0x65,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e,
	0x68, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x2e, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x2e, 0x46, 0x65, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x03, 0x46, 0x65, 0x65, 0x12, 0x14, 0x0a,
	0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x56, 0x61,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x73, 0x32, 0xd6, 0x42, 0x0a, 0x11, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x48,
...
var file_npool_cloud_hashing_goods_proto_depIdxs = []int32{
	...
	125, // 153: cloud.hashing.goods.v1.CloudHashingGoods.GetFees:input_type -> cloud.hashing.goods.v1.GetFeesRequest
	112, // 154: cloud.hashing.goods.v1.CloudHashingGoods.CreateFeeType:input_type -> cloud.hashing.goods.v1.CreateFeeTypeRequest
	114, // 155: cloud.hashing.goods.v1.CloudHashingGoods.UpdateFeeType:input_type -> cloud.hashing.goods.v1.UpdateFeeTypeRequest
	116, // 156: cloud.hashing.goods.v1.CloudHashingGoods.GetFeeType:input_type -> cloud.hashing.goods.v1.GetFeeTypeRequest
	118, // 157: cloud.hashing.goods.v1.CloudHashingGoods.GetFeeTypes:input_type -> cloud.hashing.goods.v1.GetFeeTypesRequest
	1,   // 158: cloud.hashing.goods.v1.CloudHashingGoods.Version:output_type -> cloud.hashing.goods.v1.VersionResponse
	4,   // 159: cloud.hashing.goods.v1.CloudHashingGoods.CreateVendorLocation:output_type -> cloud.hashing.goods.v1.CreateVendorLocationResponse
	8,   // 160: cloud.hashing.goods.v1.CloudHashingGoods.UpdateVendorLocation:output_type -> cloud.hashing.goods.v1.UpdateVendorLocationResponse
	6,   // 161: cloud.hashing.goods.v1.CloudHashingGoods.GetVendorLocation:output_type -> cloud.hashing.goods.v1.GetVendorLocationResponse
	10,  // 162: cloud.hashing.goods.v1.CloudHashingGoods.DeleteVendorLocation:output_type -> cloud.hashing.goods.v1.DeleteVendorLocationResponse
	12,  // 163: cloud.hashing.goods.v1.CloudHashingGoods.GetVendorLocations:output_type -> cloud.hashing.goods.v1.GetVendorLocationsResponse
	46,  // 164: cloud.hashing.goods.v1.CloudHashingGoods.CreatePriceCurrency:output_type -> cloud.hashing.goods.v1.CreatePriceCurrencyResponse
	48,  // 165: cloud.hashing.goods.v1.CloudHashingGoods.UpdatePriceCurrency:output_type -> cloud.hashing.goods.v1.UpdatePriceCurrencyResponse
	50,  // 166: cloud.hashing.goods.v1.CloudHashingGoods.GetPriceCurrency:output_type -> cloud.hashing.goods.v1.GetPriceCurrencyResponse
	52,  // 167: cloud.hashing.goods.v1.CloudHashingGoods.GetPriceCurrencys:output_type -> cloud.hashing.goods.v1.GetPriceCurrencysResponse
	15,  // 168: cloud.hashing.goods.v1.CloudHashingGoods.CreateTargetArea:output_type -> cloud.hashing.goods.v1.CreateTargetAreaResponse
	19,  // 169: cloud.hashing.goods.v1.CloudHashingGoods.UpdateTargetArea:output_type -> cloud.hashing.goods.v1.UpdateTargetAreaResponse
	17,  // 170: cloud.hashing.goods.v1.CloudHashingGoods.GetTargetArea:output_type -> cloud.hashing.goods.v1.GetTargetAreaResponse
	21,  // 171: cloud.hashing.goods.v1.CloudHashingGoods.DeleteTargetArea:output_type -> cloud.hashing.goods.v1.DeleteTargetAreaResponse
	23,  // 172: cloud.hashing.goods.v1.CloudHashingGoods.DeleteTargetAreaByContinentCountry:output_type -> cloud.hashing.goods.v1.DeleteTargetAreaByContinentCountryResponse
	25,  // 173: cloud.hashing.goods.v1.CloudHashingGoods.GetTargetAreas:output_type -> cloud.hashing.goods.v1.GetTargetAreasResponse
	28,  // 174: cloud.hashing.goods.v1.CloudHashingGoods.CreateDeviceInfo:output_type -> cloud.hashing.goods.v1.CreateDeviceInfoResponse
	30,  // 175: cloud.hashing.goods.v1.CloudHashingGoods.UpdateDeviceInfo:output_type -> cloud.hashing.goods.v1.UpdateDeviceInfoResponse
	32,  // 176: cloud.hashing.goods.v1.CloudHashingGoods.GetDeviceInfo:output_type -> cloud.hashing.goods.v1.GetDeviceInfoResponse
	34,  // 177: cloud.hashing.goods.v1.CloudHashingGoods.DeleteDeviceInfo:output_type -> cloud.hashing.goods.v1.DeleteDeviceInfoResponse
	36,  // 178: cloud.hashing.goods.v1.CloudHashingGoods.GetDeviceInfos:output_type -> cloud.hashing.goods.v1.GetDeviceInfosResponse
	39,  // 179: cloud.hashing.goods.v1.CloudHashingGoods.CreateGood:output_type -> cloud.hashing.goods.v1.CreateGoodResponse
	41,  // 180: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGood:output_type -> cloud.hashing.goods.v1.UpdateGoodResponse
	43,  // 181: cloud.hashing.goods.v1.CloudHashingGoods.GetGood:output_type -> cloud.hashing.goods.v1.GetGoodResponse
	60,  // 182: cloud.hashing.goods.v1.CloudHashingGoods.DeleteGood:output_type -> cloud.hashing.goods.v1.DeleteGoodResponse
	62,  // 183: cloud.hashing.goods.v1.CloudHashingGoods.GetGoods:output_type -> cloud.hashing.goods.v1.GetGoodsResponse
	56,  // 184: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodDetail:output_type -> cloud.hashing.goods.v1.GetGoodDetailResponse
	58,  // 185: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodsDetail:output_type -> cloud.hashing.goods.v1.GetGoodsDetailResponse
	73,  // 186: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppGood:output_type -> cloud.hashing.goods.v1.AuthorizeAppGoodResponse
	65,  // 187: cloud.hashing.goods.v1.CloudHashingGoods.SetAppGoodPrice:output_type -> cloud.hashing.goods.v1.SetAppGoodPriceResponse
	67,  // 188: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppGood:output_type -> cloud.hashing.goods.v1.CheckAppGoodResponse
	69,  // 189: cloud.hashing.goods.v1.CloudHashingGoods.OnsaleAppGood:output_type -> cloud.hashing.goods.v1.OnsaleAppGoodResponse
	71,  // 190: cloud.hashing.goods.v1.CloudHashingGoods.OffsaleAppGood:output_type -> cloud.hashing.goods.v1.OffsaleAppGoodResponse
	75,  // 191: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppGood:output_type -> cloud.hashing.goods.v1.UnauthorizeAppGoodResponse
	78,  // 192: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppTargetArea:output_type -> cloud.hashing.goods.v1.AuthorizeAppTargetAreaResponse
	80,  // 193: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppTargetArea:output_type -> cloud.hashing.goods.v1.CheckAppTargetAreaResponse
	82,  // 194: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppTargetArea:output_type -> cloud.hashing.goods.v1.UnauthorizeAppTargetAreaResponse
	85,  // 195: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppGoodTargetArea:output_type -> cloud.hashing.goods.v1.AuthorizeAppGoodTargetAreaResponse
	87,  // 196: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppGoodTargetArea:output_type -> cloud.hashing.goods.v1.CheckAppGoodTargetAreaResponse
	89,  // 197: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppGoodTargetArea:output_type -> cloud.hashing.goods.v1.UnauthorizeAppGoodTargetAreaResponse
	92,  // 198: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodComment:output_type -> cloud.hashing.goods.v1.CreateGoodCommentResponse
	94,  // 199: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodComment:output_type -> cloud.hashing.goods.v1.UpdateGoodCommentResponse
	96,  // 200: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodComments:output_type -> cloud.hashing.goods.v1.GetGoodCommentsResponse
	98,  // 201: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodExtraInfo:output_type -> cloud.hashing.goods.v1.CreateGoodExtraInfoRequest
	100, // 202: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodExtraInfo:output_type -> cloud.hashing.goods.v1.GetGoodExtraInfoRequest
	102, // 203: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodExtraInfo:output_type -> cloud.hashing.goods.v1.UpdateGoodExtraInfoRequest
	106, // 204: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodReview:output_type -> cloud.hashing.goods.v1.CreateGoodReviewResponse
	108, // 205: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodReview:output_type -> cloud.hashing.goods.v1.UpdateGoodReviewResponse
	110, // 206: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodReview:output_type -> cloud.hashing.goods.v1.GetGoodReviewResponse
	122, // 207: cloud.hashing.goods.v1.CloudHashingGoods.CreateFee:output_type -> cloud.hashing.goods.v1.CreateFeeResponse
	124, // 208: cloud.hashing.goods.v1.CloudHashingGoods.GetFee:output_type -> cloud.hashing.goods.v1.GetFeeResponse
	126, // 209: cloud.hashing.goods.v1.CloudHashingGoods.GetFees:output_type -> cloud.hashing.goods.v1.GetFeesResponse
	113, // 210: cloud.hashing.goods.v1.CloudHashingGoods.CreateFeeType:output_type -> cloud.hashing.goods.v1.CreateFeeTypeResponse
	115, // 211: cloud.hashing.goods.v1.CloudHashingGoods.UpdateFeeType:output_type -> cloud.hashing.goods.v1.UpdateFeeTypeResponse
	117, // 212: cloud.hashing.goods.v1.CloudHashingGoods.GetFeeType:output_type -> cloud.hashing.goods.v1.GetFeeTypeResponse
	119, // 213: cloud.hashing.goods.v1.CloudHashingGoods.GetFeeTypes:output_type -> cloud.hashing.goods.v1.GetFeeTypesResponse
