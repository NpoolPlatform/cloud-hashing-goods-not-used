...
var file_npool_cloud_hashing_goods_proto_depIdxs = []int32{
	1, // 0: cloud.hashing.goods.v1.CloudHashingGoods.Version:input_type -> google.protobuf.Empty
	0, // 1: cloud.hashing.goods.v1.CloudHashingGoods.Version:output_type -> cloud.hashing.goods.v1.VersionResponse
