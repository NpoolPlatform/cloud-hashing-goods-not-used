...
var file_npool_cloud_hashing_goods_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x65, 0x77, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0x9e, 0x34,
	0x0a, 0x11, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x48, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x47, 0x6f,
	0x6f, 0x64, 0x73, 0x12, 0x5c, 0x0a, 0x07, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x16,
	...
	0x3a, 0x01, 0x2a, 0x12, 0x88, 0x01, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63,
	...
	0x76, 0x31, 0x2f, 0x67, 0x65, 0x74, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x7f,
	...
	0x6f, 0x6f, 0x64, 0x3a, 0x01, 0x2a, 0x12, 0x74, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x47, 0x6f, 0x6f,
	...
	0x76, 0x31, 0x2f, 0x67, 0x65, 0x74, 0x2f, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x12, 0x98, 0x01, 0x0a,
	...
	0x67, 0x6f, 0x6f, 0x64, 0x2f, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x3a, 0x01, 0x2a, 0x42, 0x3c,
...
var file_npool_cloud_hashing_goods_proto_msgTypes = make([]protoimpl.MessageInfo, 96)
var file_npool_cloud_hashing_goods_proto_goTypes = []interface{}{
	...
	(*GetGoodReviewRequest)(nil),                       // 94: cloud.hashing.goods.v1.GetGoodReviewRequest
	(*GetGoodReviewResponse)(nil),                      // 95: cloud.hashing.goods.v1.GetGoodReviewResponse
...
var file_npool_cloud_hashing_goods_proto_depIdxs = []int32{
	...
	89,  // 72: cloud.hashing.goods.v1.GetGoodReviewRequest.Info:type_name -> cloud.hashing.goods.v1.GoodReviewInfo
	89,  // 73: cloud.hashing.goods.v1.GetGoodReviewResponse.Info:type_name -> cloud.hashing.goods.v1.GoodReviewInfo
	96,  // 74: cloud.hashing.goods.v1.CloudHashingGoods.Version:input_type -> google.protobuf.Empty
	3,   // 75: cloud.hashing.goods.v1.CloudHashingGoods.CreateVendorLocation:input_type -> cloud.hashing.goods.v1.CreateVendorLocationRequest
	7,   // 76: cloud.hashing.goods.v1.CloudHashingGoods.UpdateVendorLocation:input_type -> cloud.hashing.goods.v1.UpdateVendorLocationRequest
	5,   // 77: cloud.hashing.goods.v1.CloudHashingGoods.GetVendorLocation:input_type -> cloud.hashing.goods.v1.GetVendorLocationRequest
	9,   // 78: cloud.hashing.goods.v1.CloudHashingGoods.DeleteVendorLocation:input_type -> cloud.hashing.goods.v1.DeleteVendorLocationRequest
	11,  // 79: cloud.hashing.goods.v1.CloudHashingGoods.GetVendorLocations:input_type -> cloud.hashing.goods.v1.GetVendorLocationsRequest
	14,  // 80: cloud.hashing.goods.v1.CloudHashingGoods.CreateTargetArea:input_type -> cloud.hashing.goods.v1.CreateTargetAreaRequest
	18,  // 81: cloud.hashing.goods.v1.CloudHashingGoods.UpdateTargetArea:input_type -> cloud.hashing.goods.v1.UpdateTargetAreaRequest
	16,  // 82: cloud.hashing.goods.v1.CloudHashingGoods.GetTargetArea:input_type -> cloud.hashing.goods.v1.GetTargetAreaRequest
	20,  // 83: cloud.hashing.goods.v1.CloudHashingGoods.DeleteTargetArea:input_type -> cloud.hashing.goods.v1.DeleteTargetAreaRequest
	22,  // 84: cloud.hashing.goods.v1.CloudHashingGoods.DeleteTargetAreaByContinentCountry:input_type -> cloud.hashing.goods.v1.DeleteTargetAreaByContinentCountryRequest
	24,  // 85: cloud.hashing.goods.v1.CloudHashingGoods.GetTargetAreas:input_type -> cloud.hashing.goods.v1.GetTargetAreasRequest
	27,  // 86: cloud.hashing.goods.v1.CloudHashingGoods.CreateDeviceInfo:input_type -> cloud.hashing.goods.v1.CreateDeviceInfoRequest
	29,  // 87: cloud.hashing.goods.v1.CloudHashingGoods.UpdateDeviceInfo:input_type -> cloud.hashing.goods.v1.UpdateDeviceInfoRequest
	31,  // 88: cloud.hashing.goods.v1.CloudHashingGoods.GetDeviceInfo:input_type -> cloud.hashing.goods.v1.GetDeviceInfoRequest
	33,  // 89: cloud.hashing.goods.v1.CloudHashingGoods.DeleteDeviceInfo:input_type -> cloud.hashing.goods.v1.DeleteDeviceInfoRequest
	35,  // 90: cloud.hashing.goods.v1.CloudHashingGoods.GetDeviceInfos:input_type -> cloud.hashing.goods.v1.GetDeviceInfosRequest
	38,  // 91: cloud.hashing.goods.v1.CloudHashingGoods.CreateGood:input_type -> cloud.hashing.goods.v1.CreateGoodRequest
	40,  // 92: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGood:input_type -> cloud.hashing.goods.v1.UpdateGoodRequest
	42,  // 93: cloud.hashing.goods.v1.CloudHashingGoods.GetGood:input_type -> cloud.hashing.goods.v1.GetGoodRequest
	44,  // 94: cloud.hashing.goods.v1.CloudHashingGoods.DeleteGood:input_type -> cloud.hashing.goods.v1.DeleteGoodRequest
	46,  // 95: cloud.hashing.goods.v1.CloudHashingGoods.GetGoods:input_type -> cloud.hashing.goods.v1.GetGoodsRequest
	57,  // 96: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppGood:input_type -> cloud.hashing.goods.v1.AuthorizeAppGoodRequest
	49,  // 97: cloud.hashing.goods.v1.CloudHashingGoods.SetAppGoodPrice:input_type -> cloud.hashing.goods.v1.SetAppGoodPriceRequest
	51,  // 98: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppGood:input_type -> cloud.hashing.goods.v1.CheckAppGoodRequest
	53,  // 99: cloud.hashing.goods.v1.CloudHashingGoods.OnsaleAppGood:input_type -> cloud.hashing.goods.v1.OnsaleAppGoodRequest
	55,  // 100: cloud.hashing.goods.v1.CloudHashingGoods.OffsaleAppGood:input_type -> cloud.hashing.goods.v1.OffsaleAppGoodRequest
	59,  // 101: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppGood:input_type -> cloud.hashing.goods.v1.UnauthorizeAppGoodRequest
	62,  // 102: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppTargetArea:input_type -> cloud.hashing.goods.v1.AuthorizeAppTargetAreaRequest
	64,  // 103: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppTargetArea:input_type -> cloud.hashing.goods.v1.CheckAppTargetAreaRequest
	66,  // 104: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppTargetArea:input_type -> cloud.hashing.goods.v1.UnauthorizeAppTargetAreaRequest
	69,  // 105: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppGoodTargetArea:input_type -> cloud.hashing.goods.v1.AuthorizeAppGoodTargetAreaRequest
	71,  // 106: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppGoodTargetArea:input_type -> cloud.hashing.goods.v1.CheckAppGoodTargetAreaRequest
	73,  // 107: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppGoodTargetArea:input_type -> cloud.hashing.goods.v1.UnauthorizeAppGoodTargetAreaRequest
	76,  // 108: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodComment:input_type -> cloud.hashing.goods.v1.CreateGoodCommentRequest
	78,  // 109: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodComment:input_type -> cloud.hashing.goods.v1.UpdateGoodCommentRequest
	80,  // 110: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodComments:input_type -> cloud.hashing.goods.v1.GetGoodCommentsRequest
	83,  // 111: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodExtraInfo:input_type -> cloud.hashing.goods.v1.CreateGoodExtraInfoRequest
	85,  // 112: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodExtraInfo:input_type -> cloud.hashing.goods.v1.GetGoodExtraInfoRequest
	87,  // 113: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodExtraInfo:input_type -> cloud.hashing.goods.v1.UpdateGoodExtraInfoRequest
	90,  // 114: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodReview:input_type -> cloud.hashing.goods.v1.CreateGoodReviewRequest
	92,  // 115: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodReview:input_type -> cloud.hashing.goods.v1.UpdateGoodReviewRequest
	94,  // 116: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodReview:input_type -> cloud.hashing.goods.v1.GetGoodReviewRequest
	1,   // 117: cloud.hashing.goods.v1.CloudHashingGoods.Version:output_type -> cloud.hashing.goods.v1.VersionResponse
	4,   // 118: cloud.hashing.goods.v1.CloudHashingGoods.CreateVendorLocation:output_type -> cloud.hashing.goods.v1.CreateVendorLocationResponse
	8,   // 119: cloud.hashing.goods.v1.CloudHashingGoods.UpdateVendorLocation:output_type -> cloud.hashing.goods.v1.UpdateVendorLocationResponse
	6,   // 120: cloud.hashing.goods.v1.CloudHashingGoods.GetVendorLocation:output_type -> cloud.hashing.goods.v1.GetVendorLocationResponse
	10,  // 121: cloud.hashing.goods.v1.CloudHashingGoods.DeleteVendorLocation:output_type -> cloud.hashing.goods.v1.DeleteVendorLocationResponse
	12,  // 122: cloud.hashing.goods.v1.CloudHashingGoods.GetVendorLocations:output_type -> cloud.hashing.goods.v1.GetVendorLocationsResponse
	15,  // 123: cloud.hashing.goods.v1.CloudHashingGoods.CreateTargetArea:output_type -> cloud.hashing.goods.v1.CreateTargetAreaResponse
	19,  // 124: cloud.hashing.goods.v1.CloudHashingGoods.UpdateTargetArea:output_type -> cloud.hashing.goods.v1.UpdateTargetAreaResponse
	17,  // 125: cloud.hashing.goods.v1.CloudHashingGoods.GetTargetArea:output_type -> cloud.hashing.goods.v1.GetTargetAreaResponse
	21,  // 126: cloud.hashing.goods.v1.CloudHashingGoods.DeleteTargetArea:output_type -> cloud.hashing.goods.v1.DeleteTargetAreaResponse
	23,  // 127: cloud.hashing.goods.v1.CloudHashingGoods.DeleteTargetAreaByContinentCountry:output_type -> cloud.hashing.goods.v1.DeleteTargetAreaByContinentCountryResponse
	25,  // 128: cloud.hashing.goods.v1.CloudHashingGoods.GetTargetAreas:output_type -> cloud.hashing.goods.v1.GetTargetAreasResponse
	28,  // 129: cloud.hashing.goods.v1.CloudHashingGoods.CreateDeviceInfo:output_type -> cloud.hashing.goods.v1.CreateDeviceInfoResponse
	30,  // 130: cloud.hashing.goods.v1.CloudHashingGoods.UpdateDeviceInfo:output_type -> cloud.hashing.goods.v1.UpdateDeviceInfoResponse
	32,  // 131: cloud.hashing.goods.v1.CloudHashingGoods.GetDeviceInfo:output_type -> cloud.hashing.goods.v1.GetDeviceInfoResponse
	34,  // 132: cloud.hashing.goods.v1.CloudHashingGoods.DeleteDeviceInfo:output_type -> cloud.hashing.goods.v1.DeleteDeviceInfoResponse
	36,  // 133: cloud.hashing.goods.v1.CloudHashingGoods.GetDeviceInfos:output_type -> cloud.hashing.goods.v1.GetDeviceInfosResponse
	39,  // 134: cloud.hashing.goods.v1.CloudHashingGoods.CreateGood:output_type -> cloud.hashing.goods.v1.CreateGoodResponse
	41,  // 135: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGood:output_type -> cloud.hashing.goods.v1.UpdateGoodResponse
	43,  // 136: cloud.hashing.goods.v1.CloudHashingGoods.GetGood:output_type -> cloud.hashing.goods.v1.GetGoodResponse
	45,  // 137: cloud.hashing.goods.v1.CloudHashingGoods.DeleteGood:output_type -> cloud.hashing.goods.v1.DeleteGoodResponse
	47,  // 138: cloud.hashing.goods.v1.CloudHashingGoods.GetGoods:output_type -> cloud.hashing.goods.v1.GetGoodsResponse
	58,  // 139: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppGood:output_type -> cloud.hashing.goods.v1.AuthorizeAppGoodResponse
	50,  // 140: cloud.hashing.goods.v1.CloudHashingGoods.SetAppGoodPrice:output_type -> cloud.hashing.goods.v1.SetAppGoodPriceResponse
	52,  // 141: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppGood:output_type -> cloud.hashing.goods.v1.CheckAppGoodResponse
	54,  // 142: cloud.hashing.goods.v1.CloudHashingGoods.OnsaleAppGood:output_type -> cloud.hashing.goods.v1.OnsaleAppGoodResponse
	56,  // 143: cloud.hashing.goods.v1.CloudHashingGoods.OffsaleAppGood:output_type -> cloud.hashing.goods.v1.OffsaleAppGoodResponse
	60,  // 144: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppGood:output_type -> cloud.hashing.goods.v1.UnauthorizeAppGoodResponse
	63,  // 145: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppTargetArea:output_type -> cloud.hashing.goods.v1.AuthorizeAppTargetAreaResponse
	65,  // 146: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppTargetArea:output_type -> cloud.hashing.goods.v1.CheckAppTargetAreaResponse
	67,  // 147: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppTargetArea:output_type -> cloud.hashing.goods.v1.UnauthorizeAppTargetAreaResponse
	70,  // 148: cloud.hashing.goods.v1.CloudHashingGoods.AuthorizeAppGoodTargetArea:output_type -> cloud.hashing.goods.v1.AuthorizeAppGoodTargetAreaResponse
	72,  // 149: cloud.hashing.goods.v1.CloudHashingGoods.CheckAppGoodTargetArea:output_type -> cloud.hashing.goods.v1.CheckAppGoodTargetAreaResponse
	74,  // 150: cloud.hashing.goods.v1.CloudHashingGoods.UnauthorizeAppGoodTargetArea:output_type -> cloud.hashing.goods.v1.UnauthorizeAppGoodTargetAreaResponse
	77,  // 151: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodComment:output_type -> cloud.hashing.goods.v1.CreateGoodCommentResponse
	79,  // 152: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodComment:output_type -> cloud.hashing.goods.v1.UpdateGoodCommentResponse
	81,  // 153: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodComments:output_type -> cloud.hashing.goods.v1.GetGoodCommentsResponse
	83,  // 154: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodExtraInfo:output_type -> cloud.hashing.goods.v1.CreateGoodExtraInfoRequest
	85,  // 155: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodExtraInfo:output_type -> cloud.hashing.goods.v1.GetGoodExtraInfoRequest
	87,  // 156: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodExtraInfo:output_type -> cloud.hashing.goods.v1.UpdateGoodExtraInfoRequest
	91,  // 157: cloud.hashing.goods.v1.CloudHashingGoods.CreateGoodReview:output_type -> cloud.hashing.goods.v1.CreateGoodReviewResponse
	93,  // 158: cloud.hashing.goods.v1.CloudHashingGoods.UpdateGoodReview:output_type -> cloud.hashing.goods.v1.UpdateGoodReviewResponse
	95,  // 159: cloud.hashing.goods.v1.CloudHashingGoods.GetGoodReview:output_type -> cloud.hashing.goods.v1.GetGoodReviewResponse
