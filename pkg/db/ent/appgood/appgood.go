...
const (
	...
	FieldGoodID = "good_id"
	// FieldAuthorized holds the string denoting the authorized field in the database.
	FieldAuthorized = "authorized"
...
var (
	// DefaultAuthorized holds the default value on creation for the "authorized" field.
