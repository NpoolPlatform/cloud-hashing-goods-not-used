...
func init() {
	...
	appgoodDescCreateAt := appgoodFields[7].Descriptor()
	...
	appgoodDescUpdateAt := appgoodFields[8].Descriptor()
	...
	appgoodDescDeleteAt := appgoodFields[9].Descriptor()
	...
	goodinfoDescTotal := goodinfoFields[19].Descriptor()
	...
	goodinfoDescCreateAt := goodinfoFields[20].Descriptor()
	...
	goodinfoDescUpdateAt := goodinfoFields[21].Descriptor()
	...
	goodinfoDescDeleteAt := goodinfoFields[22].Descriptor()
