...
// Returns a *NotSingularError when exactly one Currency entity is not found.
...
// Returns a *NotSingularError when exactly one Currency ID is not found.
