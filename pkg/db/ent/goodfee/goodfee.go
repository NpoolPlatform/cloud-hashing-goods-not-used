...
const (
	// Label holds the string label denoting the goodfee type in the database.
	Label = "good_fee"
	...
	// Table holds the table name of the goodfee in the database.
	Table = "good_fees"
)
...
func PayTypeValidator(pt PayType) error {
	...
	case PayTypePercent, PayTypeAmount:
		return nil
	default:
		return fmt.Errorf("goodfee: invalid enum value for pay_type field: %q", pt)
	}
}
