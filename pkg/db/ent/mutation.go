...
// FeeDurationMutation represents an operation that mutates the FeeDuration nodes in the graph.
type FeeDurationMutation struct {
	config
	op            Op
	typ           string
	id            *uuid.UUID
	...
	oldValue      func(context.Context) (*FeeDuration, error)
	predicates    []predicate.FeeDuration
}

var _ ent.Mutation = (*FeeDurationMutation)(nil)

// feedurationOption allows management of the mutation configuration using functional options.
type feedurationOption func(*FeeDurationMutation)

// newFeeDurationMutation creates new mutation for the FeeDuration entity.
func newFeeDurationMutation(c config, op Op, opts ...feedurationOption) *FeeDurationMutation {
	m := &FeeDurationMutation{
		config:        c,
		op:            op,
		typ:           TypeFeeDuration,
		clearedFields: make(map[string]struct{}),
...
// withFeeDurationID sets the ID field of the mutation.
func withFeeDurationID(id uuid.UUID) feedurationOption {
	return func(m *FeeDurationMutation) {
		var (
			err   error
			once  sync.Once
			value *FeeDuration
		)
		m.oldValue = func(ctx context.Context) (*FeeDuration, error) {
			once.Do(func() {
				if m.done {
					err = fmt.Errorf("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().FeeDuration.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withFeeDuration sets the old FeeDuration of the mutation.
func withFeeDuration(node *FeeDuration) feedurationOption {
	return func(m *FeeDurationMutation) {
		m.oldValue = func(context.Context) (*FeeDuration, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m FeeDurationMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m FeeDurationMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, fmt.Errorf("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of FeeDuration entities.
func (m *FeeDurationMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *FeeDurationMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// SetFeeTypeID sets the "fee_type_id" field.
func (m *FeeDurationMutation) SetFeeTypeID(u uuid.UUID) {
	m.fee_type_id = &u
}

// FeeTypeID returns the value of the "fee_type_id" field in the mutation.
func (m *FeeDurationMutation) FeeTypeID() (r uuid.UUID, exists bool) {
	v := m.fee_type_id
	if v == nil {
		return
	}
...
// OldFeeTypeID returns the old "fee_type_id" field's value of the FeeDuration entity.
// If the FeeDuration object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FeeDurationMutation) OldFeeTypeID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldFeeTypeID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetFeeTypeID resets all changes to the "fee_type_id" field.
func (m *FeeDurationMutation) ResetFeeTypeID() {
	m.fee_type_id = nil
}

// SetDuration sets the "duration" field.
func (m *FeeDurationMutation) SetDuration(i int32) {
	m.duration = &i
	m.addduration = nil
}

// Duration returns the value of the "duration" field in the mutation.
func (m *FeeDurationMutation) Duration() (r int32, exists bool) {
	v := m.duration
	if v == nil {
		return
	}
...
// OldDuration returns the old "duration" field's value of the FeeDuration entity.
// If the FeeDuration object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FeeDurationMutation) OldDuration(ctx context.Context) (v int32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FeeDurationMutation) AddDuration(i int32) {
...
func (m *FeeDurationMutation) AddedDuration() (r int32, exists bool) {
	v := m.addduration
	if v == nil {
		return
	}
...
func (m *FeeDurationMutation) ResetDuration() {
	m.duration = nil
	m.addduration = nil
}

// SetCreateAt sets the "create_at" field.
func (m *FeeDurationMutation) SetCreateAt(u uint32) {
	m.create_at = &u
	m.addcreate_at = nil
}

// CreateAt returns the value of the "create_at" field in the mutation.
func (m *FeeDurationMutation) CreateAt() (r uint32, exists bool) {
	v := m.create_at
	if v == nil {
		return
	}
...
// OldCreateAt returns the old "create_at" field's value of the FeeDuration entity.
// If the FeeDuration object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FeeDurationMutation) OldCreateAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldCreateAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddCreateAt adds u to the "create_at" field.
func (m *FeeDurationMutation) AddCreateAt(u uint32) {
	if m.addcreate_at != nil {
		*m.addcreate_at += u
	} else {
		m.addcreate_at = &u
...
// AddedCreateAt returns the value that was added to the "create_at" field in this mutation.
func (m *FeeDurationMutation) AddedCreateAt() (r uint32, exists bool) {
	v := m.addcreate_at
	if v == nil {
		return
	}
...
// ResetCreateAt resets all changes to the "create_at" field.
func (m *FeeDurationMutation) ResetCreateAt() {
	m.create_at = nil
	m.addcreate_at = nil
}

// SetUpdateAt sets the "update_at" field.
func (m *FeeDurationMutation) SetUpdateAt(u uint32) {
	m.update_at = &u
	m.addupdate_at = nil
}

// UpdateAt returns the value of the "update_at" field in the mutation.
func (m *FeeDurationMutation) UpdateAt() (r uint32, exists bool) {
	v := m.update_at
	if v == nil {
		return
	}
...
// OldUpdateAt returns the old "update_at" field's value of the FeeDuration entity.
// If the FeeDuration object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FeeDurationMutation) OldUpdateAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldUpdateAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddUpdateAt adds u to the "update_at" field.
func (m *FeeDurationMutation) AddUpdateAt(u uint32) {
	if m.addupdate_at != nil {
		*m.addupdate_at += u
	} else {
		m.addupdate_at = &u
...
// AddedUpdateAt returns the value that was added to the "update_at" field in this mutation.
func (m *FeeDurationMutation) AddedUpdateAt() (r uint32, exists bool) {
	v := m.addupdate_at
	if v == nil {
		return
	}
...
// ResetUpdateAt resets all changes to the "update_at" field.
func (m *FeeDurationMutation) ResetUpdateAt() {
	m.update_at = nil
	m.addupdate_at = nil
}

// SetDeleteAt sets the "delete_at" field.
func (m *FeeDurationMutation) SetDeleteAt(u uint32) {
	m.delete_at = &u
	m.adddelete_at = nil
}

// DeleteAt returns the value of the "delete_at" field in the mutation.
func (m *FeeDurationMutation) DeleteAt() (r uint32, exists bool) {
	v := m.delete_at
	if v == nil {
		return
	}
...
// OldDeleteAt returns the old "delete_at" field's value of the FeeDuration entity.
// If the FeeDuration object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FeeDurationMutation) OldDeleteAt(ctx context.Context) (v uint32, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldDeleteAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddDeleteAt adds u to the "delete_at" field.
func (m *FeeDurationMutation) AddDeleteAt(u uint32) {
	if m.adddelete_at != nil {
		*m.adddelete_at += u
	} else {
		m.adddelete_at = &u
...
// AddedDeleteAt returns the value that was added to the "delete_at" field in this mutation.
func (m *FeeDurationMutation) AddedDeleteAt() (r uint32, exists bool) {
	v := m.adddelete_at
	if v == nil {
		return
	}
...
// ResetDeleteAt resets all changes to the "delete_at" field.
func (m *FeeDurationMutation) ResetDeleteAt() {
	m.delete_at = nil
	m.adddelete_at = nil
}

// Where appends a list predicates to the FeeDurationMutation builder.
func (m *FeeDurationMutation) Where(ps ...predicate.FeeDuration) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *FeeDurationMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (FeeDuration).
func (m *FeeDurationMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *FeeDurationMutation) Fields() []string {
	fields := make([]string, 0, 5)
	if m.fee_type_id != nil {
		fields = append(fields, feeduration.FieldFeeTypeID)
	}
	if m.duration != nil {
		fields = append(fields, feeduration.FieldDuration)
	}
	if m.create_at != nil {
		fields = append(fields, feeduration.FieldCreateAt)
	}
	if m.update_at != nil {
		fields = append(fields, feeduration.FieldUpdateAt)
	}
	if m.delete_at != nil {
		fields = append(fields, feeduration.FieldDeleteAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *FeeDurationMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *FeeDurationMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case feeduration.FieldFeeTypeID:
		return m.OldFeeTypeID(ctx)
	case feeduration.FieldDuration:
	...
	return nil, fmt.Errorf("unknown FeeDuration field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *FeeDurationMutation) SetField(name string, value ent.Value) error {
	switch name {
	case feeduration.FieldFeeTypeID:
		v, ok := value.(uuid.UUID)
		if !ok {
	...
	return fmt.Errorf("unknown FeeDuration field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *FeeDurationMutation) AddedFields() []string {
	var fields []string
	if m.addduration != nil {
		fields = append(fields, feeduration.FieldDuration)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *FeeDurationMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case feeduration.FieldDuration:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *FeeDurationMutation) AddField(name string, value ent.Value) error {
	switch name {
	case feeduration.FieldDuration:
		v, ok := value.(int32)
		if !ok {
	...
	return fmt.Errorf("unknown FeeDuration numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *FeeDurationMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *FeeDurationMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *FeeDurationMutation) ClearField(name string) error {
	return fmt.Errorf("unknown FeeDuration nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *FeeDurationMutation) ResetField(name string) error {
	switch name {
	case feeduration.FieldFeeTypeID:
		m.ResetFeeTypeID()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *FeeDurationMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *FeeDurationMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *FeeDurationMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *FeeDurationMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *FeeDurationMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *FeeDurationMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *FeeDurationMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown FeeDuration unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *FeeDurationMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown FeeDuration edge %s", name)
}
