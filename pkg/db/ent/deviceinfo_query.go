...
func (diq *DeviceInfoQuery) GroupBy(field string, fields ...string) *DeviceInfoGroupBy {
	group := &DeviceInfoGroupBy{config: diq.config}
...
func (diq *DeviceInfoQuery) Select(fields ...string) *DeviceInfoSelect {
	...
	return &DeviceInfoSelect{DeviceInfoQuery: diq}
}
...
func (diq *DeviceInfoQuery) sqlAll(ctx context.Context) ([]*DeviceInfo, error) {
	var (
		nodes = []*DeviceInfo{}
		_spec = diq.querySpec()
	)
...
func (digb *DeviceInfoGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (digb *DeviceInfoGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(digb.fields) > 1 {
		return nil, errors.New("ent: DeviceInfoGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := digb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (digb *DeviceInfoGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (digb *DeviceInfoGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{deviceinfo.Label}
	default:
		err = fmt.Errorf("ent: DeviceInfoGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (digb *DeviceInfoGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (digb *DeviceInfoGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(digb.fields) > 1 {
		return nil, errors.New("ent: DeviceInfoGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := digb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (digb *DeviceInfoGroupBy) IntsX(ctx context.Context) []int {
	v, err := digb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (digb *DeviceInfoGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{deviceinfo.Label}
	default:
		err = fmt.Errorf("ent: DeviceInfoGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (digb *DeviceInfoGroupBy) IntX(ctx context.Context) int {
	v, err := digb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (digb *DeviceInfoGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(digb.fields) > 1 {
		return nil, errors.New("ent: DeviceInfoGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := digb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (digb *DeviceInfoGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (digb *DeviceInfoGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{deviceinfo.Label}
	default:
		err = fmt.Errorf("ent: DeviceInfoGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (digb *DeviceInfoGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (digb *DeviceInfoGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(digb.fields) > 1 {
		return nil, errors.New("ent: DeviceInfoGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := digb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (digb *DeviceInfoGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (digb *DeviceInfoGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{deviceinfo.Label}
	default:
		err = fmt.Errorf("ent: DeviceInfoGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (digb *DeviceInfoGroupBy) BoolX(ctx context.Context) bool {
	v, err := digb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (dis *DeviceInfoSelect) ScanX(ctx context.Context, v interface{}) {
...
func (dis *DeviceInfoSelect) Strings(ctx context.Context) ([]string, error) {
	if len(dis.fields) > 1 {
		return nil, errors.New("ent: DeviceInfoSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := dis.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (dis *DeviceInfoSelect) StringsX(ctx context.Context) []string {
...
func (dis *DeviceInfoSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{deviceinfo.Label}
	default:
		err = fmt.Errorf("ent: DeviceInfoSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (dis *DeviceInfoSelect) StringX(ctx context.Context) string {
...
func (dis *DeviceInfoSelect) Ints(ctx context.Context) ([]int, error) {
	if len(dis.fields) > 1 {
		return nil, errors.New("ent: DeviceInfoSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := dis.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (dis *DeviceInfoSelect) IntsX(ctx context.Context) []int {
	v, err := dis.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (dis *DeviceInfoSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{deviceinfo.Label}
	default:
		err = fmt.Errorf("ent: DeviceInfoSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (dis *DeviceInfoSelect) IntX(ctx context.Context) int {
	v, err := dis.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (dis *DeviceInfoSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(dis.fields) > 1 {
		return nil, errors.New("ent: DeviceInfoSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := dis.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (dis *DeviceInfoSelect) Float64sX(ctx context.Context) []float64 {
...
func (dis *DeviceInfoSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{deviceinfo.Label}
	default:
		err = fmt.Errorf("ent: DeviceInfoSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (dis *DeviceInfoSelect) Float64X(ctx context.Context) float64 {
...
func (dis *DeviceInfoSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(dis.fields) > 1 {
		return nil, errors.New("ent: DeviceInfoSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := dis.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (dis *DeviceInfoSelect) BoolsX(ctx context.Context) []bool {
	v, err := dis.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (dis *DeviceInfoSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{deviceinfo.Label}
	default:
		err = fmt.Errorf("ent: DeviceInfoSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (dis *DeviceInfoSelect) BoolX(ctx context.Context) bool {
	v, err := dis.Bool(ctx)
	if err != nil {
		panic(err)
	}
